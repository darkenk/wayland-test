...
class WaylandSurface
    : public WaylandResource<WaylandSurface, wl_surface_interface, struct wl_surface_interface>
{
public:
...
protected:
    ...
    virtual void surfaceAttach(wl_client* /*client*/, wl_resource* /*resource*/,
                               wl_resource* /*buffer*/, int32_t /*sx*/, int32_t /*sy*/) {}

    virtual void surfaceFrame(wl_client* /*client*/, wl_resource* /*resource*/,
                              uint32_t /*callback*/) {}
...
private:
    ...
    static void surfaceDamage(wl_client* /*client*/, wl_resource* /*resource*/, int32_t /*x*/,
    ...
    static void surfaceSetBufferTransform(wl_client* /*client*/, wl_resource* /*resource*/,
                                          int /*transform*/) {}

    static void surfaceSetBufferScale(wl_client* /*client*/, wl_resource* /*resource*/,
                                      int32_t /*scale*/) {}
};
